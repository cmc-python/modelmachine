...
class TestControlUnitR:
    ...
    @pytest.mark.parametrize(
        ("opcode", "bits"),
        [
            (Opcode.halt, 0xFF0000),
            (Opcode.load, 0x0F0000),
            (Opcode.store, 0x0F0000),
            (Opcode.add, 0x0F0000),
            (Opcode.sub, 0x0F0000),
            (Opcode.smul, 0x0F0000),
            (Opcode.umul, 0x0F0000),
            (Opcode.sdiv, 0x0F0000),
            (Opcode.udiv, 0x0F0000),
            (Opcode.comp, 0x0F0000),
            (Opcode.jump, 0xFF0000),
            (Opcode.jeq, 0xFF0000),
            (Opcode.jneq, 0xFF0000),
            (Opcode.sjl, 0xFF0000),
            (Opcode.sjgeq, 0xFF0000),
            (Opcode.sjleq, 0xFF0000),
            (Opcode.sjg, 0xFF0000),
            (Opcode.ujl, 0xFF0000),
            (Opcode.ujgeq, 0xFF0000),
            (Opcode.ujleq, 0xFF0000),
            (Opcode.ujg, 0xFF0000),
        ],
    )
