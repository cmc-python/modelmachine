...
<details>
  ...
  в `mm-v` и `mm-m`. Возможна ситуация, при которой процессор попытается
  ...
  Такая ситуация является ошибочной и машина будет остановлена.

  Деления на ноль является ошибочной ситуацией и машина будет остановлена.
