...
* Необязательная директива `.enter NUMBERS...` вводит числа для
  директивы `.input`.
  - Требуется вводить ровно столько чисел, сколько директив `.input`
...
предыдущей командой. Удобно его использовать, если нужно сравнить значение
с нулем или  если результат выполнения операции по какой-то причине не
требуется в дальнейшем выполнении программы.
