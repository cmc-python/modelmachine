...
class ArithmeticLogicUnit:
    ...
    register_map - map of register names
    ...
    * S, RES - summator and residual (for divmod) (operand_bits)
    ...
    def __init__(
        ...
        *,
        ...
        self._registers.add_register(register_map.S, bits=operand_bits)
        self._registers.add_register(register_map.RES, bits=operand_bits)
        self._registers.add_register(register_map.R1, bits=operand_bits)
        self._registers.add_register(register_map.R2, bits=operand_bits)
        self._registers.add_register(RegisterName.FLAGS, bits=operand_bits)

    def _set_flags(self, *, signed: int, unsigned: int) -> None:
        """Set flags."""
        flags = Flags.CLEAR
        value = self._registers[self.register_map.S]
        if value == 0:
            flags |= Flags.ZF
    ...
    def _operands(self) -> tuple[Cell, Cell]:
        ...
        return (
            self._registers[self.register_map.R1],
            self._registers[self.register_map.R2],
        )
    ...
    def _binary_op(
        ...
        *,
        ...
        s = cell_op(op1, op2)
        self._registers[self.register_map.S] = s
    ...
    def sdivmod(self) -> None:
        ...
        try:
            ...
            raise AluZeroDivisionError() from e

        self._registers[self.register_map.S] = div
        self._registers[self.register_map.RES] = mod
    ...
    def udivmod(self) -> None:
        ...
        try:
            ...
            msg = "Division by zero, cpu halted"
    ...
    def move(self) -> None:
        """dest := source."""
        self._registers[self.register_map.S] = self._registers[self.register_map.R1]

    def swap(self) -> None:
        """S := R1."""
        s = self._registers[self.register_map.S]
        res = self._registers[self.register_map.RES]

        self._registers[self.register_map.S] = res
        self._registers[self.register_map.RES] = s
